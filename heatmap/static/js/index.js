$(function () {
    ...
    // vars
    var userGaugeMax = 3000, userGaugeShowMax = 2000;
    var computeGaugeMax = 50, computeGaugeShowMax = 40;
    //var userGaugeMax = 6000, userGaugeShowMax = 4000;
    ...
    setInterval(function () {
        var currentVal = computeCount;          // GET
        var maxVal = computeGaugeShowMax;
        var newVal = Math.round(userCount / computeGaugeMax);
        newVal = Math.min(newVal, maxVal);
